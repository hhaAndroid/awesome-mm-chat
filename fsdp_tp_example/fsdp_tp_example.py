...
# torchrun --nproc-per-node=4 python fsdp_tp_example.py
# srun -p llm_razor --gres=gpu:4 --ntasks=1 --ntasks-per-node=1 torchrun --nproc-per-node=4 python fsdp_tp_example.py
